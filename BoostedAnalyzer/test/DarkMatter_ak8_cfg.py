...
if not options.inputFiles:
    if options.isData:
        ...
        #SingleElectron
        # options.inputFiles=["root://xrootd-cms.infn.it//store/data/Run2016D/SingleElectron/MINIAOD/03Feb2017-v1/110000/001A5DEC-77EB-E611-95CD-0CC47A4C8EE8.root"]
        #MET
        ...
        #WW
        # options.inputFiles = ["root://xrootd-cms.infn.it///store/mc/RunIISummer16MiniAODv2/WW_TuneCUETP8M1_13TeV-pythia8/MINIAODSIM/PUMoriond17_80X_mcRun2_asymptotic_2016_TrancheIV_v6-v1/60000/00E95BAA-C3D7-E611-A416-0025905A60BC.root"]
        #Z+Jets
...
process.BoostedAnalyzer.channel=("signal")   #signal/SingleMuon/SingleElectron/DoubleMuon/DoubleElectron
