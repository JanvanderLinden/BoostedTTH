...
class BoostedJetProducer : public edm::stream::EDProducer<> {
public:
  explicit BoostedJetProducer(const edm::ParameterSet&);
  ~BoostedJetProducer();
...
//
BoostedJetProducer::BoostedJetProducer(const edm::ParameterSet& iConfig)
{
...
BoostedJetProducer::~BoostedJetProducer()
{
...
void
BoostedJetProducer::produce(edm::Event& iEvent, const edm::EventSetup& iSetup)
{
  using namespace edm;
...
std::string BoostedJetProducer::systName(std::string name, Systematics::Type sysType) {
...
void
BoostedJetProducer::beginStream(edm::StreamID)
{
}

// ------------ method called once each stream after processing all runs, lumis and events  ------------
void
BoostedJetProducer::endStream() {
}

// ------------ method called when starting to processes a run  ------------
/*
void
BoostedJetProducer::beginRun(edm::Run const&, edm::EventSetup const&)
{
}
*/
...
/*
void
BoostedJetProducer::endRun(edm::Run const&, edm::EventSetup const&)
{
}
*/
...
/*
void
BoostedJetProducer::beginLuminosityBlock(edm::LuminosityBlock const&, edm::EventSetup const&)
{
}
*/
...
/*
void
BoostedJetProducer::endLuminosityBlock(edm::LuminosityBlock const&, edm::EventSetup const&)
{
}
*/
...
void
BoostedJetProducer::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
...
DEFINE_FWK_MODULE(BoostedJetProducer);